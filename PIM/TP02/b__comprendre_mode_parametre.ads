...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_comprendre_mode_parametre" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#57dbf6d4#;
   pragma Export (C, u00001, "comprendre_mode_parametreB");
